...
<head>
    ...
    <title>Monitoring Dashboard Assam</title>
</head>
...
<body>
    ...
    <section id="hero">
        <div class="max-w-6xl mx-auto text-center mb-40 px-10 pt-16">
            <svg class="mx-auto my-16" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                version="1.1" width="150" height="150" viewBox="0 0 256 256" xml:space="preserve">
                <defs></defs>
                <g style="
							stroke: none;
							stroke-width: 0;
            ...
            <h3 class="mb-8 text-4xl font-bold text-strongCyan md:text-5xl">
                Monitoring Dashboard, Assam Circle
            </h3>
            <p class="max-w-3xl mx-auto mb-10 text-2xl text-Blue">
                A dashboard for monitoring various projects of Assam Postal Circle
            </p>
            <div
                class="flex flex-col justify-center w-full space-y-6 text-xl text-white md:flex-row md:space-y-0 md:space-x-4">
                <a href="{{ route('login') }}"
                    class="p-4  rounded-2xl shadow lg shadow-zinc-900 bg-lightGreen duration-200 hover:opacity-80">Login</a>
                <a href="{{ route('register') }}"
                    class="p-4 rounded-2xl shadow lg shadow-zinc-900 bg-lightBlue duration-200 hover:opacity-80">Register</a>
            </div>
        </div>
    </section>
</body>
